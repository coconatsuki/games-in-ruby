...
class Challenging_player_text
  ...
  def perfect_match
    puts "\nPlease tell me which colors are correct AND in the good position."
  ...
  def matching_colors
    puts "---------------------------"
    puts "\nNow, please write which colors are correct BUT in the wrong position."
